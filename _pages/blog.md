...
<div class="tag-category-list">
  <ul class="p-0 m-0">
    {% for tag in site.display_tags %}
      ...
      {% unless forloop.last and site.display_categories.size == 0 %}
        <p>&bull;</p>
      {% endunless %}
    {% endfor %}
...
<nav class="pagination justify-content-center" aria-label="Pagination">
  {% if paginator.previous_page %}
    <a href="{{ paginator.previous_page_path | relative_url }}" class="pagination-item older">&larr; <span class="hide-on-mobile">Newer</span></a>
  {% else %}
    <span class="pagination-item older disabled">&larr; <span class="hide-on-mobile">Newer</span></span>
  {% endif %}
  {% if paginator.next_page %}
    <a href="{{ paginator.next_page_path | relative_url }}" class="pagination-item newer"><span class="hide-on-mobile">Older</span> &rarr;</a>
  {% else %}
    <span class="pagination-item newer disabled"><span class="hide-on-mobile">Older</span> &rarr;</span>
  {% endif %}
</nav>
{% endif %}
